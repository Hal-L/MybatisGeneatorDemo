...
public class GeneratorStart {
    ...
    private static void generateByTables(boolean serviceNameStartWithI, String packageName, String... tableNames) {
        ...
        String dbUrl = "jdbc:mysql://47.104.197.98:3306/shrek_guid?useUnicode=true&useSSL=false&characterEncoding=utf8";
        dataSourceConfig
        ...
        // 自定义 com.example.mapper 父类
        // strategyConfig.setSuperMapperClass("com.baomidou.demo.TestMapper");
        // 自定义 com.example.service 父类
        //strategyConfig.setSuperServiceClass("com.baomidou.demo.TestService");
        // 自定义 com.example.service 实现类父类
        //strategyConfig.setSuperServiceImplClass("com.baomidou.demo.TestServiceImpl");
        // 自定义 com.example.controller 父类
        strategyConfig.setSuperControllerClass("com.gzsys.common.base.com.example.controller.BaseController");
        ...
        mpg.setGlobalConfig(config)  //全局 相关配置
                ...
                .setPackageInfo( //包 相关配置
                        new PackageConfig()  //跟包相关的配置项
                                ...
                                .setController("com.example.controller") //Controller包名
                                .setEntity("com.example.entity") //entity包名
                                //.setXml("/")
                )
                .execute();
    }
